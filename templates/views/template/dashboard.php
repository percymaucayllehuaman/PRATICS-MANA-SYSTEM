...
<head>
  ...
  <!-- plugins:css -->
  <?php
    require('../../views/links/dashboard_assets.php');
  ?>
</head>
<body>
  ...
  <!-- plugins:js -->
  <script src="/registrocivil/assets/vendors/base/vendor.bundle.base.js"></script>
  <!-- endinject -->
  <!-- Plugin js for this page-->
  <script src="/registrocivil/assets/vendors/chart.js/Chart.min.js"></script>
  <script src="/registrocivil/assets/js/jquery.cookie.js" type="text/javascript"></script>
  <!-- End plugin js for this page-->
  <!-- inject:js -->
  <script src="/registrocivil/assets/js/off-canvas.js"></script>
  <script src="/registrocivil/assets/js/hoverable-collapse.js"></script>
  <script src="/registrocivil/assets/js/template.js"></script>
  <script src="/registrocivil/assets/js/todolist.js"></script>
  <!-- endinject -->
  <!-- Custom js for this page-->
  <script src="/registrocivil/assets/js/dashboard.js"></script>
